...
A pathogen has an effective within-host population size of $N_e=100$ and a generation time $g=1$ day, so that $N_e g=100/365$ years. The default basic reproduction number is $R=1$. The following command simulates an outbreak of this pathogen: 
<<>>=
simu <- simulateOutbreak(neg=100/365,pi=0.2)
@
